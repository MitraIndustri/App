		...
		$data_user = mysqli_fetch_assoc($check_user);
    		if (empty($post_password)) {
				...
				$msg_content = "<strong>Failed : </strong>Wrong username or password.<META HTTP-EQUIV=Refresh CONTENT=\"3; URL=/login\">";
				    ...
				    mysqli_query($db, "INSERT INTO ip_log (username, action, ip, date, time) VALUES ('$post_username', 'Masuk', '$post_ip', '$date', '$time')");
            ...
            <div class="ms-panel-body">
              ...
              <form method="POST">
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="email" class="form-control" name="username" value="<?php echo $data_user['email']; ?>" placeholder="Masukkan Email" required>
                  </div>
                </div>
                ...
                <div class="form-group row">
					  ...
					  <div class="col-sm-10">
						<button type="submit" class="btn btn-primary shadow-primary btn-round px-5" name="login"><i class="icon-lock"></i> Kirim Verifikasi</button>
					  </div>
					</div>
              </form>
